/*
  ...
  - You are about to drop the column `preRequisitedId` on the `CourseToPrerequisite` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "CourseToPrerequisite" DROP CONSTRAINT "CourseToPrerequisite_preRequisitedId_fkey";

-- AlterTable
ALTER TABLE "CourseToPrerequisite" DROP CONSTRAINT "CourseToPrerequisite_pkey",
DROP COLUMN "preRequisitedId",
